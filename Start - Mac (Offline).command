...
#
# Requires Python 3.12 and Docker Desktop already installed on this machine —
# neither is bundled. Double-click to run.
...
if ! command -v python3.12 &>/dev/null; then
  ...
  echo "   \"Start - Mac.command\" in a regular checkout of the repo.)"
  echo ""
...
if ! command -v docker &>/dev/null; then
  ...
  echo "  Docker Desktop must already be installed to run MobSF for APK scanning —"
  echo "  it isn't bundled here. Install it from:"
